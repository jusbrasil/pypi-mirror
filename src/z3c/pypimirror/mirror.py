...
class Mirror(object):
    ...
    def _index_html(self):
        ...
        generator = "<p class='footer'>Generated by %s; %d packages mirrored. For details see the <a href='http://www.openplans.org/projects/pypi-mirroring'>pypi mirroring z3c.pypimirror project page.</a></p>" % (pypimirror_version(), len(_ls))
        footer = "</body></html>\n"
